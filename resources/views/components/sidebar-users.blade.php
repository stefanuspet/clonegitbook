<aside
    ...
    class="absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden text-white bg-[#22272E] duration-300 ease-linear bg-boxdark lg:static lg:translate-x-0"
        ...
        <nav
            ...
            <div class="w-44">
                ...
                <ul class="mb-6 flex flex-col gap-1.5">
                    ...
                    <li>
                        <a
                            class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark hover:bg-meta-4"
                            href="calendar.html"
                    ...
                    <li class="px-2">
                        ...
                        <ul id="dropdown-example" class="hidden py-2 space-y-2">
                            <li>
                                <a href="#" class="flex gap-x-3 items-center w-full p-2  transition duration-75 rounded-lg pl-11 group  text-white hover:bg-gray-700">
                                    <span>Add Space</span>
